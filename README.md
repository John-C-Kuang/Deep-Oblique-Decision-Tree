# Deep Oblique Decision Tree (DODT)
[Deep Oblique Decision Tree (DODT): A Novel Approach For Multi-class Classification](https://github.com/John-C-Kuang/Deep-Oblique-Decision-Tree/blob/main/Deep%20Oblique%20Decision%20Tree.pdf)
### Links:  
